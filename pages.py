...
<div class="wrap">
  <div class="card">
    <div class="brand"></div>
      <div><div class="brand-nam
      <div class="brand-img">e">Aurevonfilter</div><div class="brand-sub">v9.8</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='aurevonfilter';document.getElementById('pw').focus()">aurevonfilter</span>
    </div>
    <form id="form">
      <div class="field">
    ...
    <div class="footer">بات تلگرام  <a href="https://t.me/Aurevonfilterbot" target="_blank"><i class="ti ti-brand-telegram"></i>https://t.me/AurevonFilter</a></div>
  </div>
</div>
<script>
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      ...
      <div><div class="brand-name">Aurevonfilter</div><div class="brand-sub">v9.8</div></div>
    </div>
  ...
  <div class="footer">یات خرید کانفیگ: <a href="https://t.me/Aurevonfilterbot" target="_blank">https://t.me/AurevonFilter</a> · X4G v9.8</div>
</div>
<script>
...
function renderContent(d){{
  ...
  window._aurevonfilterSubUrl  = subUrl;
  window._aurevonfilterSubName = d.name;
  window._aurevonfilterLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    sub   : l.sub_url,
    label : l.label,
  }}));
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._aurevonfilterSubName + ' — کل گروه', window._x4gSubUrl)">
